...
- **README.md** (root): Use the **same star + level markers** in the scenario lists and section headings so the GitHub view matches `index.json` descriptions. List scenarios in **markdown tables** with columns for the folder link, a compact Killercoda badge (`[![Killercoda](https://img.shields.io/badge/Killercoda-2496ED?style=flat-square)](https://killercoda.com/kubernauten/scenario/<scenario-folder>)`), and a short description.
